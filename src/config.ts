...
export const siteConfig: SiteConfig = {
	title: "桐の小窝",
	subtitle: "Vanitas Vanitatum Et Omnia Vanitas",
	...
	banner: {
		enable: true,
		src: "assets/images/demo-banner.avif", // Relative to the /src directory. Relative to the /public directory if it starts with '/'
